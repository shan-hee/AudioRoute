...
- **真实会话静音** — 静音时保留原音量，解除静音后无需重新调整滑块
- **按设备保留音量** — 应用切换到其他音频设备后，各设备的会话音量互不覆盖，切回时恢复对应音量
- **输出/输入双模式** — 支持播放设备（输出）和录音设备（输入）的管理
- **系统托盘常驻** — 作为托盘程序后台运行，左键点击托盘图标唤出面板，右键打开菜单
- **托盘快捷调音** — 鼠标位于托盘图标上时滚轮每格调节主音量 2%，中键切换主静音
...
- 左键点击托盘图标重新打开面板
- 右键点击托盘图标打开菜单（主页 / 退出）
- 在托盘图标上滚动鼠标滚轮，每格调整默认输出设备主音量 2%
- 中键点击托盘图标，切换默认输出设备主静音
